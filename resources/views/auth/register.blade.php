				...
				<div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						...
						<div class="text-center mt-4">
							<h1 class="h2">SECAPA AD</h1>
							<p class="lead">
								Register untuk bisa masuk ke dalam aplikasi.
							</p>
						</div>
                    ...
                    @csrf
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="text" name="fullname" placeholder="Masukan nama lengkap" />
										</div>
										<div class="mb-3">
